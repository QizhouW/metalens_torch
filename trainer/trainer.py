...
class Trainer(BaseTrainer):
    ...
    def __init__(self, model, criterion, metric_ftns, optimizer, config, device,
        ...
        self.csv_path = config.log_dir / 'loss.csv'
        ...
        self.log_step = int(data_loader.batch_size) // 2
    ...
    def _train_epoch(self, epoch):
        ...
        if self.do_validation:
            ...
            with open(self.csv_path , 'a', newline='') as file:
                writer = csv.writer(file)
                writer.writerow([epoch, np.mean(loss_ls), val_loss])
    ...
    def _valid_epoch(self, epoch):
        ...
        with torch.no_grad():
            for batch_idx, (_,data, target) in enumerate(self.valid_data_loader):
                ...
                #self.writer.add_histogram('Output', output, epoch)
